...
<head>
	...
	<title>Innovation Lab | Adult</title>
		...
		<div id="containit">
			...
			<div id="calender">
				...
				<div id="calender-container">
					...
					<?php
					$the_query2 = new WP_Query( array( 'post_type' => 'tribe_events', 'paged' => $paged, 'tax_query'=> array(array('taxonomy' => 'tribe_events_cat','field' => 'slug','terms' => 'adult')) ) );
					//print_r($the_query2);
