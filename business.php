...
<head>
	...
	<title>Innovation Lab | Business</title>
		...
		<div id="main">
			<div id="containit">
				...
				<div id="calender">
					...
					<?php
					$the_query2 = new WP_Query( array( 'post_type' => 'tribe_events', 'paged' => $paged, 'tax_query'=> array(array('taxonomy' => 'tribe_events_cat','field' => 'slug','terms' => 'business')) ) );
					//print_r($the_query2);
